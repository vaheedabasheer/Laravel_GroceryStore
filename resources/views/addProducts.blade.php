  ...
  @endif
   ...
   @if(session('success'))
 <center><h4 style="color:green">{{session('success')}}</h4>
 </center>
 @endif
  <center><h4 style="color:black;font-family: var(--bs-body-font-family);">Add Product Details</h4></center>
...
<tr>
    <td></td>
    <td><button type="submit" name="submit" class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Submit</button></td>
   
</tr>
</table>
</form>
<br>
<center><a href="{{route('viewProducts')}}"><button class="btn btn-success text-uppercase fs-6 rounded-pill px-4 py-3 mt-3" >View Products</button></a></center>
<br>
